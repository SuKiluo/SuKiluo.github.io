  ...
  init: function (start) {
    if (start != 0){
      ...
      if (i !== -1) {
        ...
        S.UI.simulate('|#countdown 3||祝|王晋阳|生日快乐|祝你|生日快乐|祝你身体健康|祝你学业有成|前途光明|祝你|生日快乐！|#icon heart|#icon heart-empty|#icon heart|嘿嘿，还不错吧|#image|');
      }
    ...
    timedAction(function (index) {
      ...
      switch (action) {
        ...
        case 'image':
          ...
          // document.getElementById('image').style.animationDuration='5s';
          break;
        default:
